...
public class housecommonroom extends Fragment {
    ...
    private static DatabaseReference mDatabase,houseDatabase;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.housecommonroom, container, false);
        recyclerView=rootView.findViewById(R.id.rv_chat);
        btnSend = (Button) rootView.findViewById(R.id.btn_send);
        mAuth = FirebaseAuth.getInstance();
        mFirebaseInstance = FirebaseDatabase.getInstance();
        houseDatabase=mFirebaseInstance.getReference("users");
                        ...
                        houseDatabase.addValueEventListener(new ValueEventListener() {
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                ...
                                if(house.equalsIgnoreCase("gryffindor")){
                                    mDatabaseReference.child("chat").child("gryffindor")
                                            .push()
                                            .setValue(param)
                                ...
                                if(house.equalsIgnoreCase("hufflepuff")){
                                    mDatabaseReference.child("chat").child("hufflepuff")
                                            .push()
                                            .setValue(param)
                                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                @Override
                                ...
                                if(house.equalsIgnoreCase("ravenclaw")){
                                    mDatabaseReference.child("chat").child("ravenclaw")
                                            .push()
                                            .setValue(param)
                                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                @Override
                                ...
                                if(house.equalsIgnoreCase("slytherin")){
                                    mDatabaseReference.child("chat").child("slytherin")
                                            .push()
                                            .setValue(param)
                                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                @Override
